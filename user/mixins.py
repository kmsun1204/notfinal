...
class VerifyEmailMixin:
    verification_template_name = 'user/email/registration_verification.html'
    ...
    def send_verification_email(self, user):
        ...
        html_message = render(self.request, self.verification_template_name, {'url': url}).content.decode('utf-8')
