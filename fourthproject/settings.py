...
SECRET_KEY = 'h7i527c-1sx4ods1#-sg6q9rd545$7=z(ts_eecz2j2l_a21h+'
...
AUTH_PASSWORD_VALIDATORS = [
    {
        ...
        'OPTION': {'user_attributes': ('email', 'first_name', 'username')},
    },
    {
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'blog', 'user', 'posts', 'static')
]
